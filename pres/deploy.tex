		...
		\label{tab:inputs}
			...
			\hline
				...
				\multirow{5}{*}{\textbf{Required}} & Demand driving commodity                                                           & Power, Fuel, Plutonium, etc.                                                                                                                      \\ 
														  ...
														  & Available facilities                                                              & Fuel Fab, LWR reactor, SFR reactor, Waste repository, etc.                                                                                                      \\ \cline{2-3} 
				...
				\multirow{4}{*}{\textbf{Optional}} & Buffer type                                                                        & Absolute                                                                                                                  \\ \cline{2-3} 
														  & CBuffer size                                                                        & \begin{tabular}[c]{@{}l@{}}Power: 3000 MW\\ Fuel: 0 kg \\ Spent fuel: 0 kg\end{tabular}                                   \\ \cline{2-3} 
														  & Facility preferences (transition time)                                                              & \begin{tabular}[c]{@{}l@{}}LWR reactor preferred $\leq$ 100 time steps\\ SFR reactor preferred $>$ 100 time steps \end{tabular}          \\ \cline{2-3} 
